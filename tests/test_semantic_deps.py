...
_HISTORICALLY_SHIPPED_SHAS = frozenset(
    {
        ...
        "911ad6dd28259c4da4c63a1cc32b68de06e967377773f4d467ff3c9541103f5c",
        "e1711da64528498ef76d1161a7f0c54e026a45742778dde2e9d0e25dbc6de2a0",
...
_PINNED_FRAGMENT_GEOMETRY_SHA256_V8 = "ccd95b43ed5f048a77428ec6a8f199a34f6158a4a1b66f2d1ef746a1916a2491"

# SUPERSEDED -- the NINTH, whose fragments carried a single right edge: the ADVANCE
# extent, trailing spacing included. On the real target table that read a two-glyph
# `Tc`-spaced show as 92.019 pt wider than its ink, and the containment test that read
# it refused the whole table for spacing it never drew. The TENTH publishes the ink
# extent alongside it (`TextFragment.ink_x_end`); the advance extent is unchanged.
_PINNED_FRAGMENT_GEOMETRY_OWN_SHA256_V9 = "ab24abb65eb68fdfbc6634289124465143bdd3d2720e095b322f2bf2df89000d"
_PINNED_FRAGMENT_GEOMETRY_SHA256_V9 = "911ad6dd28259c4da4c63a1cc32b68de06e967377773f4d467ff3c9541103f5c"

# SUPERSEDED -- the TENTH, whose fragments' text was always exactly what pypdf decoded,
# unmapped glyph names included. The ELEVENTH adds the evidence-scoped glyph-repair
# table: text can now be a character Carmel concluded from recorded evidence, and the
# fragment says so via GlyphMapping.REPAIRED.
_PINNED_FRAGMENT_GEOMETRY_OWN_SHA256_V10 = "54de5761c2a1dc3c188b83880f86cbd5d302d309d5dfc99e2a397f8614012611"
_PINNED_FRAGMENT_GEOMETRY_SHA256_V10 = "e1711da64528498ef76d1161a7f0c54e026a45742778dde2e9d0e25dbc6de2a0"

# SUPERSEDED -- the ELEVENTH, whose fragments carried two scalars per horizontal
# extent and nothing about their interior. The TWELFTH records per-glyph ink evidence
# (`TextFragment.glyph_intervals`), the substrate of the inventory's sub-fragment
# split; no coordinate moved on any of the eight corpus documents.
_PINNED_FRAGMENT_GEOMETRY_OWN_SHA256_V11 = "e9b97bd5b6485f9d1cf78ca461096f46a2e7ed6993ce62081b0c776deeb96e9a"
_PINNED_FRAGMENT_GEOMETRY_SHA256_V11 = "b8f3e9a95a425c12eeabddea34c0614261a896933c31bd28f5622044c7ccde1a"

# SUPERSEDED -- the TWELFTH, whose glyph-repair table repaired only glyphs the document
# left UNMAPPED. The THIRTEENTH extends it to MIS-DECODED glyphs: a symbol font's
# phi-as-'f' or en-dash-as-'e' that decodes to valid Latin and so surfaced MAPPED and
# unrepaired. Four entries ship for 10.1016-j.ijhydene.2013.10.164; 210 fragments move on
...
def test_the_superseded_fragment_geometry_row_is_still_resolvable() -> None:
    ...
    for superseded_sha in (
        ...
        _PINNED_FRAGMENT_GEOMETRY_SHA256_V8,
        _PINNED_FRAGMENT_GEOMETRY_SHA256_V9,
        _PINNED_FRAGMENT_GEOMETRY_SHA256_V10,
        _PINNED_FRAGMENT_GEOMETRY_SHA256_V11,
        _PINNED_FRAGMENT_GEOMETRY_SHA256_V12,
    ):
...
def test_every_superseded_geometry_row_is_distinct() -> None:
    ...
    owns = (
        ...
        _PINNED_FRAGMENT_GEOMETRY_OWN_SHA256_V8,
        _PINNED_FRAGMENT_GEOMETRY_OWN_SHA256_V9,
        _PINNED_FRAGMENT_GEOMETRY_OWN_SHA256_V10,
        _PINNED_FRAGMENT_GEOMETRY_OWN_SHA256_V11,
        _PINNED_FRAGMENT_GEOMETRY_OWN_SHA256_V12,
