...
_SI_INVENTORY = make_embedded_inventory(raw_sha256=SHA_B, cells=((0, 1),))
"""A DELIBERATELY narrow inventory (one cell) over the SI member's own bytes.

The shared wide fixture grid would put ~198 KB of canonical JSON inside
