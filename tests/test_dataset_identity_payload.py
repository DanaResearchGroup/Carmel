...
_SI_INVENTORY = make_embedded_inventory(raw_sha256=SHA_B, cells=((0, 0), (0, 1), (1, 2)))
"""DELIBERATELY narrow grids: these fixtures feed _GOLDEN_CANONICAL_BYTES, which
exists to be re-read by eye, and the shared wide fixture grid would bury it under
~198 KB of canonical JSON per citation."""
...
def _maximal_graph() -> tuple[SourceGraph, SourceRef, SourceRef, SourceRef, SourceRef, SourceRef]:
    ...
    table_ref_caption = SourceRef(
        ...
        locator=TableCellLocator(
            ...
            row=0,
            col=1,
            pdf_table_inventory_sha256=_SI_INVENTORY.inventory_sha256,
        ),
    )
