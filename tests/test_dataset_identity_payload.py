...
_PAPER_EXTRACTION = ExtractionBinding(extracted_sha256=SHA_A, extracted_text_sha256=SHA_E)
...
def _minimal_envelope_with_glyph_health(health: GlyphHealth) -> DatasetEnvelope:
    ...
    extraction = ExtractionBinding(extracted_sha256=SHA_A, extracted_text_sha256=SHA_E)
